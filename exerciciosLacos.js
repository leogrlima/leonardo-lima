...
for (let numero of lista) {
  if (numero > 18) {
    ...
    //Sim, pois a váriavel "numero" armazena o índice. Basta atribuir a váriavel dentro do for com o comando "lista.indexOf(numero)", que retornará o índice.
...
let pergunta = ask.question("Quantos bichinhos de estimacao voce tem? ")
let pets = []

if (pergunta == 0) {
   console.log("Que pena! Você pode adotar um pet!")
} else if (pergunta > 0) {
    while (pergunta > pets.length) {
        let nomePet = ask.question("Que legal! Qual o nome dele(s)? ")
        pets.push(nomePet)
    }
    console.log(pets)
}
